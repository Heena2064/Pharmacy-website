  ...
  return (
   <section id='about' className='about section' data-aos="fades-up">
    <div className='about-container'>
        ...
        <p>
           With over <strong>10+ years of experience</strong>, we focus on
          customer safety, affordable pricing, and fast service. 
        </p>

        <p className='about-highlight'>
           ✔ Trusted by hundreds of families <br />
          ✔ Genuine & quality medicines <br />
